function trainModel_yas_dropout(layerset, dataSize) % Using Oja's rule
...
net = Network_new_dropout([784, layerset,2],image_batch*2);
...
test_image_batch_count = 2*image_batch;
for h = 1: margin/image_batch 
    
    test_image_batch=[];
    for k=1:test_image_batch_count
...
plotPerformance([1 : newIterations*image_batch*trainingIterations*0.5]', norms, testLabels, clusters, [1, 2, 3]);
